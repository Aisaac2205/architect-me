import {
    ...
    SiNextdotjs, SiRailway, SiIonic, SiFlutter,
    SiFastapi
} from 'react-icons/si';
...
const AngularIcon = (props: IconProps) =>
    React.createElement('img', {
...
const AntigravityIcon = (props: IconProps) =>
    React.createElement('img', {
        src: '/assets/antigravity-color.svg',
        alt: 'Antigravity',
        className: props.className,
        style: { width: '1.2em', height: '1.2em', ...props.style }
    });
...
const PlaywrightIcon = (props: IconProps) =>
    React.createElement('img', {
        src: '/assets/Playwright--Streamline-Svg-Logos.svg',
        alt: 'Playwright',
        className: props.className,
        style: { width: '1.2em', height: '1.2em', ...props.style }
    });
...
const PostgresSqlIcon = (props: IconProps) =>
    React.createElement('img', {
...
const ExpressIcon = (props: IconProps) =>
...
const AstroIcon = (props: IconProps) =>
    React.createElement('div', {
        style: {
            backgroundColor: '#ffffff',
            borderRadius: '50%',
...
const JestIcon = (props: IconProps) =>
...
export const techStack = [
    ...
    { name: 'Next.js', Icon: NextIcon, color: '#000000', bgColor: 'transparent', sizeClass: 'text-5xl' },
    { name: 'Angular', Icon: AngularIcon, color: '#DD0031', bgColor: '#0e0e0eff' },
    ...
    { name: 'Astro', Icon: AstroIcon, color: '#FF5D01', bgColor: 'transparent' },
    { name: 'Java', Icon: JavaIcon, color: '#007396', bgColor: 'transparent' },
    ...
    { name: 'FastAPI', Icon: SiFastapi, color: '#009688', bgColor: 'transparent' },
    { name: 'Python', Icon: PythonIcon, color: '#3776AB', bgColor: 'transparent' },
    { name: 'Antigravity', Icon: AntigravityIcon, color: '#4F46E5', bgColor: 'transparent' },
    { name: 'Playwright', Icon: PlaywrightIcon, color: '#2EAD33', bgColor: 'transparent' },
    { name: 'Jest', Icon: JestIcon, color: '#C21325', bgColor: 'transparent' },
    { name: 'Jira', Icon: JiraIcon, color: '#0052CC', bgColor: 'transparent' },
