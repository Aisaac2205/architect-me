    ...
    return (
        ...
        >
            ...
            >
                <picture>
                    <source
                        srcSet={`${project.image.replace('.jpg', '-400w.webp')} 400w, ${project.image.replace('.jpg', '-800w.webp')} 800w`}
                        sizes="(max-width: 768px) 350px, 450px"
                        type="image/webp"
                    />
                    <img
                        src={project.image}
                        srcSet={`${project.image.replace('.jpg', '-400w.jpg')} 400w, ${project.image.replace('.jpg', '-800w.jpg')} 800w`}
                        sizes="(max-width: 768px) 350px, 450px"
